...
if (isset($_POST['submit'])) {
    ...
    $jenis_pengaduan = "Prasarana"; // Tetapkan jenis pengaduan

    // Upload photo
    $foto = $_FILES['foto']['name'];
    $tmp = $_FILES['foto']['tmp_name'];
    $fotobaru = $foto;
    $path = "assets/images-uploaded/" . $fotobaru; // Correct path

    if (move_uploaded_file($tmp, $path)) {
        $sql = "INSERT INTO pengaduan (tgl_pengaduan, nis, isi_laporan, foto, status, jenis_pengaduan) 
                VALUES ('$tgl_pengaduan', '$nis', '$isi_laporan', '$fotobaru', 'Pending', '$jenis_pengaduan')";
...
<style>
    ...
    <title>Pengaduan Prasarana - Digital School</title>
 ...
 <div class="bg-white rounded-lg shadow-lg mb-6 animate__animated animate__fadeIn">
        ...
        <div class="bg-white rounded-lg shadow-lg mb-6 animate__animated animate__fadeIn">
            <div class="bg-purple-600 text-white p-4 rounded-t-lg flex items-center">
                ...
                <h2 class="text-lg font-semibold">Form Pengaduan Prasarana</h2>
            </div>
            <div class="p-4">
    ...
    or
    <input type="file" id="images" name="foto" accept="image/*" required>
</label>
                    </div>
        ...
        <div class="bg-white rounded-lg shadow-lg mb-6 animate__animated animate__fadeIn">
            <div class="bg-purple-600 text-white p-4 rounded-t-lg flex items-center">
                ...
                <h2 class="text-lg font-semibold">Riwayat Pengaduan Prasarana</h2>
            </div>
            <div class="p-4">
                <div class="overflow-x-auto">
                    <table class="w-full">
                        ...
                        <tbody>
                            ...
                            $no = 1;
                            $nis = $_SESSION['nis'];
                            $query = mysqli_query($conn, "SELECT * FROM pengaduan WHERE nis='$nis' AND jenis_pengaduan='Prasarana' ORDER BY id_pengaduan DESC");
